...
-- tier: A
-- purpose: Espelhos das tabelas Protheus (SA3, CC2, ZA7, SF2, SC5), métricas derivadas (12m, último pedido),
--   log de ingestão e views unificadas (castor_clientes_derived, castor_client_metrics).
-- depends: 001
-- IDEMPOTENTE.
